...
export const maskedComparisonReality: RealityContent = {
  ...
  whatSimModels: [
    'A real bit of the ML-KEM shared secret (from a genuine keygen/encaps/decaps round-trip) as the masked decision bit the attack recovers.',
    'Deterministic single-bit Hamming-weight share leakage with configurable Gaussian noise.',
    'Higher-order correlation analysis over simulated trace sets.',
